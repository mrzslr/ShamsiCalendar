...
import com.mohammadreza.salari.shlibrary.Utils.PersianCalendar;
import com.mohammadreza.salari.shlibrary.Utils.PersianCalendarConstants;
...
/*
    ...
    public CalendarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        externalPersianCalendar = a.getBoolean(R.styleable.CalendarView_externalPersianCalendar, false);
        disableAddKey = a.getBoolean(R.styleable.CalendarView_disableAddKey, false);

        mInflater = LayoutInflater.from(context);
        View view = mInflater.inflate(R.layout.calendar_view, this);
        if (!externalPersianCalendar) {
